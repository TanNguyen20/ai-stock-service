...
if run:
    try:
        ...
        if not news:
            ...
            merged = pxdf.merge(daily_sent, left_on="date_only", right_on="date", how="left", suffixes=("_px","_news"))
            ...
            with left:
                fig1 = px.line(merged, x="date", y=["Close", "sent_roll3"], labels={"value":"Giá / Sentiment", "date":"Ngày"})
